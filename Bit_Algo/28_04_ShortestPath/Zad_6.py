...
1. Rozw dla grafow rzadkich:
    W sposob banalny usuwamy krawedz (x,y) i puszczamy algorytm Dijkstry z y do x, do otrzymanej odleglosci dod ajemy wage krawedzi w(x,y), robimy to dla kazdej krawedzi (Ewentualnie mozna jakos przyspieszyc i chodzic tylko po cykli, skoro i tak bd mieli duza zlozonosc)
    --> O(E^2 logV )
