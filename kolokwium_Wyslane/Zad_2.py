...
Dzmitry Mikialevich
 """
""" 
Pomysl polega na tym, ze trzeba znalezc element pod ideksem len(T)-q-1 i len(T)-p-1 w tablice posortowanej rosnaco(Korzystajac z QuickSelect lub z Median of Medians (Median of Medians jest zawsze O(n)))
...
print(MedianOfMedians(lister,1))    
